                  ...
                  children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: DropdownButton(
                              ...
                              items: controller
                                  .newUserRegData.response!.countries!
                          ...
                          child: Container(
                              ...
                              child: _.citySector != null
                                  ? DropdownButton(
                                      ...
                                      items: _.citySector!.response!.map<
                                              DropdownMenuItem<
                                                  sector.Response>>(
                                          (sector.Response? value) {
                    ...
                    Container(
                        ...
                        child: DropdownButton(
                          ...
                          items: controller.newUserRegData.response!.religions!
                              .map<DropdownMenuItem<Religions>>(
                                  (Religions? value) {
                          ...
                          child: Container(
                            ...
                            child: DropdownButton(
                              ...
                              hint: Center(
                                child: RestInvestTitle(
                                  textAlign: TextAlign.center,
                                  text: _.maritalStatusValue == null ||
                            ...
                            child: DropdownButton(
                              ...
                              hint: Center(
                                child: RestInvestTitle(
                                  textAlign: TextAlign.center,
                                  text:
                                      _.filerValue == null || _.filerValue == ""
                                          ? "Filer/NonFiler"
                                          : _.filerValue,
                                  textColor: AppColor.black,
                                ),
                    ...
                    CustomRoundButton(
                        ...
                        onPress: () {
                          _.onRegNewUser(
                              ...
                              _.countryCode,
                              _.phoneController.value.text,
                              _.cellController.value.text,
                              _.emailController.value.text,
                              _.genderValue,
                              controller.occupationCode,
                              controller.incomeCode,
                              controller.nameController.value.text,
                              controller.cNicController.value.text,
                              controller.passPortController.value.text,
                              controller.ntnController.value.text,
                              _.cityCode,
                              _.otherCityController.value.text,
                              _.sectorCode,
                              _.faxController.value.text,
                              _.dateOfBirth,
                              _.maritalStatusValue,
                              controller.bracketCode,
                              _.religionCode,
                              _.filerValue,
                              _.pinCodeController.value.text,
                              _.newUserPinGenration!.response!.pinCodeConfigId!
                                  .toString());
