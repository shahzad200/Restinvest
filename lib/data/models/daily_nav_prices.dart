...
class Response {
  ...
  Response.fromJson(Map<String, dynamic> json) {
    dailyExchangeFundNavList = List.from(json['dailyExchangeFundNavList'])
        .map((e) => DailyExchangeFundNavList.fromJson(e))
        .toList();
    dailyMutualFundNavList = List.from(json['dailyMutualFundNavList'])
        .map((e) => DailyMutualFundNavList.fromJson(e))
        .toList();
    dailyPensionFundNavList = List.from(json['dailyPensionFundNavList'])
        .map((e) => DailyPensionFundNavList.fromJson(e))
        .toList();
  ...
  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['dailyExchangeFundNavList'] =
        dailyExchangeFundNavList!.map((e) => e.toJson()).toList();
    _data['dailyMutualFundNavList'] =
        dailyMutualFundNavList!.map((e) => e.toJson()).toList();
    _data['dailyPensionFundNavList'] =
        dailyPensionFundNavList!.map((e) => e.toJson()).toList();
